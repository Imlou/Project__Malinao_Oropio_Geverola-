...
<body>
  ...
  <header class="nav-header">
    ...
    <nav class="nav-flex"> <!--start nav-flex-->
        ...
        <p class= "color-white open-sans uppercase mx-1 display-none ">home</p>
        <p class= "color-white open-sans uppercase mx-1 display-none border-aqua"><a href="index.html">home</a></p>
        ...
        <p class="color-white open-sans uppercase mx-1 display-none border-aqua"><a href="register_form.php">register here</a></p>
